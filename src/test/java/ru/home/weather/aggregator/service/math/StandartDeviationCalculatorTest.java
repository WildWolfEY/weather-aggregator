...
class StandartDeviationCalculatorTest {
    ...
    void calculateStandardDeviation() {
        ...
        Assert.isTrue (0d==calculator.calculateStandardDeviation(sequence),"Неверный расчёт среднеквадратического отклонения");
    }

    @Test
    void calculateStandardDeviationAverage() {
        List sequence = new ArrayList(List.of(2,4,4,4,5,5,7,9));
        Assert.isTrue(2==calculator.calculateStandardDeviationAverage(sequence),"Неверный расчёт среднеквадратического отклонения");
    }

    @Test
    void calculateAverage() {
        List sequence = new ArrayList(List.of(2,4,4,4,5,5,7,9));
        Assert.isTrue(5d==calculator.calculateAverage(sequence),"Неверный расчёт среднего арифметического");
    }
}